const C='kyk-v166';
const A=['./','./index.html','./css/style.css?v=1.6.6','./js/app.js?v=1.6.6','./js/jszip.min.js?v=1.6.6','./js/xlsx.full.min.js?v=1.6.6','./manifest.json?v=1.6.6','./version.json','./KYKDB.xlsx'];
