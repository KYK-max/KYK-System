const C='kyk-v165';
const A=['./','./index.html','./css/style.css?v=1.6.5','./js/app.js?v=1.6.5','./js/jszip.min.js?v=1.6.5','./js/xlsx.full.min.js?v=1.6.5','./manifest.json?v=1.6.5','./version.json','./KYKDB.xlsx'];
